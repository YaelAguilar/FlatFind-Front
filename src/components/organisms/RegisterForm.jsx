function RegisterForm() {
  return (
    <form className="w-full max-w-sm mx-auto p-6 bg-white rounded shadow-md">
      <div className="mb-4">
        <label className="block text-dark-brown text-sm font-bold mb-2" htmlFor="name">
          Nombre
        </label>
        <input className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-yellow-400 focus:border-yellow-400" id="name" type="text" placeholder="Nombre Completo" />
      </div>
      <div className="mb-4">
